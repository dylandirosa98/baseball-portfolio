...
function ProductWindow() {
  return (
    <div className="relative mx-auto w-full max-w-[650px]">
      <div className="absolute -inset-10 rounded-full bg-[#e01010]/20 blur-3xl" />
      <div className="relative overflow-hidden rounded-[1.6rem] border border-white/15 bg-[#09131c] shadow-[0_45px_100px_rgba(0,0,0,0.55)]">
        ...
        <div className="relative min-h-[460px] overflow-hidden sm:min-h-[520px]">
          ...
          <span className="absolute right-4 top-12 font-mono text-[8rem] font-black leading-none text-[#e01010]/25 sm:text-[11rem]">12</span>
          <div className="absolute inset-x-0 bottom-0 z-10 p-5 sm:p-8">
            <p className="font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#ff7a7a]">Shortstop · Class of 2027</p>
  ...
  return (
    <main className="overflow-hidden bg-[#f2eee3] text-[#071018]">
      <section className="relative min-h-screen overflow-hidden bg-[#071018] text-white">
        ...
        <div className="absolute -left-40 top-48 h-[32rem] w-[32rem] rounded-full border-[5rem] border-[#e01010]/10" />
        <header className="relative z-30 border-b border-white/10 bg-[#071018]/80 backdrop-blur-xl">
          <div className="mx-auto flex h-20 max-w-[1440px] items-center justify-between px-4 sm:px-7 lg:px-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/builder" className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-[#e01010] px-4 text-sm font-black text-white transition hover:bg-[#f02525]">
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100vh-5rem)] max-w-[1440px] items-center gap-16 px-4 py-16 sm:px-7 lg:grid-cols-[0.86fr_1.14fr] lg:px-10 lg:py-20">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-white/55">
              <span className="h-1.5 w-1.5 rounded-full bg-[#e01010]" /> Built for baseball recruiting
            </div>
            <h1 className="mt-8 max-w-2xl text-[clamp(3.6rem,7.6vw,7.5rem)] font-black uppercase leading-[0.78] tracking-[-0.07em]">
              More than<br /><span className="text-[#e01010]">a stat line.</span>
            </h1>
      ...
      <section className="border-b border-[#071018]/15 bg-[#e01010] text-white">
      ...
      <section id="product" className="py-20 sm:py-28">
        <div className="mx-auto max-w-[1320px] px-4 sm:px-7">
          <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-end">
            <div>
              <p className="font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#b91c1c]">The recruiting packet evolved</p>
          ...
          <div className="mt-14 grid gap-4 lg:grid-cols-12">
            <article className="relative min-h-[430px] overflow-hidden rounded-2xl bg-[#071018] p-6 text-white sm:p-8 lg:col-span-7">
              ...
              <div className="relative z-10 flex items-start justify-between gap-4">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#e01010]"><Film className="h-5 w-5" /></span>
              ...
              <div className="absolute inset-x-6 bottom-6 z-10 sm:inset-x-8 sm:bottom-8">
                <div className="mb-6 flex aspect-video items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-[linear-gradient(135deg,#172b3b,#0b1721)]">
                  <CirclePlay className="h-14 w-14 text-[#ff7a7a]" />
                </div>
            ...
            <article className="rounded-2xl border border-[#071018]/15 bg-white p-6 sm:p-8 lg:col-span-4">
              <BarChart3 className="h-6 w-6 text-[#b91c1c]" />
      ...
      <section id="designs" className="bg-[#071018] py-20 text-white sm:py-28">
        <div className="mx-auto max-w-[1320px] px-4 sm:px-7">
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            <div><p className="font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#ff7a7a]">Not another template dump</p><h2 className="mt-4 max-w-3xl text-4xl font-black uppercase leading-[0.9] tracking-[-0.05em] sm:text-6xl">Three ways to own the first impression.</h2></div>
              ...
              <article key={design.name} className="group overflow-hidden rounded-2xl border border-white/10 bg-white/[0.025]">
                <div className={`relative flex aspect-[4/5] overflow-hidden bg-gradient-to-br p-5 ${design.tone} ${design.position}`}>
                  ...
                  <div className="relative z-10">
                    <p className="font-mono text-[9px] uppercase tracking-[0.22em] text-[#ff7a7a]">Design {design.number}</p>
          ...
          <div className="mt-10 text-center">
            <Link href="/builder" className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-[#e01010] px-5 font-black">Try every design free <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-[#071018]/10 bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-7">
          <div className="text-center">
            <p className="font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#b91c1c]">From blank page to shared link</p>
          ...
          <div className="mt-16 grid gap-px overflow-hidden rounded-2xl border border-[#071018]/15 bg-[#071018]/15 md:grid-cols-3">
            {[
              ...
              <article key={step} className="bg-[#f2eee3] p-7 sm:p-9">
                <div className="flex items-center justify-between"><span className="font-mono text-xs font-bold text-[#b91c1c]">{step}</span><Icon className="h-5 w-5 text-[#071018]/35" /></div>
      ...
      <section className="bg-[#d9e7e2] py-20 sm:py-28">
        <div className="mx-auto grid max-w-[1320px] items-center gap-14 px-4 sm:px-7 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-[#071018]/15 bg-[#071018] p-5 text-white shadow-2xl sm:p-7">
            <div className="flex items-center justify-between"><div><p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#ff7a7a]">Last 30 days</p><h3 className="mt-2 text-xl font-black">Portfolio performance</h3></div><BarChart3 className="h-5 w-5 text-white/30" /></div>
            <div className="mt-8 flex h-52 items-end gap-2">
              {[24, 38, 18, 56, 44, 72, 52, 88, 62, 100, 74, 92, 68, 84, 96].map((height, index) => (
                <div key={index} className="flex h-full min-w-0 flex-1 items-end gap-px"><span className="w-1/2 rounded-t-sm bg-[#e01010]" style={{ height: height + "%" }} /><span className="w-1/2 rounded-t-sm bg-[#f4c95d]" style={{ height: Math.max(8, height * 0.52) + "%" }} /></div>
              ))}
            </div>
      ...
      <section className="bg-[#071018] py-20 text-white sm:py-28">
        <div className="mx-auto max-w-[1320px] px-4 sm:px-7">
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            <div><p className="font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#ff7a7a]">Stories will live here</p><h2 className="mt-4 text-4xl font-black uppercase leading-[0.9] tracking-[-0.05em] sm:text-6xl">Built for the people behind the player.</h2></div>
          ...
          <div className="mt-12 grid gap-4 lg:grid-cols-3">
            {testimonials.map((testimonial, index) => (
              <article key={testimonial.person} className="flex min-h-72 flex-col rounded-2xl border border-white/10 bg-white/[0.035] p-6">
                <span className="font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-[#ff7a7a]">Placeholder testimonial {String(index + 1).padStart(2, "0")}</span>
      ...
      <section id="pricing" className="py-20 sm:py-28">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-7">
          <div className="text-center">
            <p className="font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#b91c1c]">Straightforward pricing</p>
            ...
            {plans.map((plan) => {
              ...
              return (
                <article key={plan.name} className={`relative flex flex-col rounded-2xl border p-6 sm:p-8 ${featured ? "border-[#071018] bg-[#071018] text-white shadow-2xl" : "border-[#071018]/15 bg-white"}`}>
                  {featured && <span className="absolute right-5 top-5 rounded-full bg-[#e01010] px-3 py-1 text-[9px] font-black uppercase tracking-[0.14em]">Most popular</span>}
                  <p className={`font-mono text-[9px] font-bold uppercase tracking-[0.18em] ${featured ? "text-[#ff7a7a]" : "text-[#b91c1c]"}`}>{plan.eyebrow}</p>
                  ...
                  <ul className={`mt-8 flex-1 space-y-3 border-t pt-6 text-sm ${featured ? "border-white/10 text-white/70" : "border-[#071018]/10 text-[#071018]/65"}`}>
                    {plan.features.map((feature) => <li key={feature} className="flex gap-3"><Check className={`mt-0.5 h-4 w-4 shrink-0 ${featured ? "text-[#ff7a7a]" : "text-[#b91c1c]"}`} />{feature}</li>)}
                  </ul>
      ...
      <section className="bg-[#e01010] py-20 text-white sm:py-24">
