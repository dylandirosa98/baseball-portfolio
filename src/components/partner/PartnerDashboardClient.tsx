      ...
      <div className="mx-auto max-w-[1500px] px-4 py-7 sm:px-7">
        ...
        {tab === "domain" && <section className="mt-6 grid gap-6 lg:grid-cols-2">
          {organization.partnership_type === "white_label" ? <form action={connectDomain} className="rounded-2xl border border-white/10 bg-[#0b131c] p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-white/45">Use your apex domain, such as academybaseball.com. The builder will run at <strong className="text-white/70">build.yourdomain.com</strong> and each athlete will run at <strong className="text-white/70">slug.yourdomain.com</strong>.</p>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0b131c] p-6">
            ...
            <div className="mt-5 space-y-3 text-sm">
              ...
              {organization.partnership_type === "white_label" && <div className="flex items-center justify-between rounded-lg border border-white/10 px-4 py-3"><span className="text-white/55">White-label platform fee</span><strong>$200/mo</strong></div>}
