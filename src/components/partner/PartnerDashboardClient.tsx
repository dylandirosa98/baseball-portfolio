...
export default function PartnerDashboardClient({ organization, stripeStatus, role, athletes, paymentLinks, memberCount }: { organization: PartnerOrganizationRow; stripeStatus: PartnerStripeAccountStatus | null; role: PartnerRole; athletes: Athlete[]; paymentLinks: PaymentLink[]; memberCount: number }) {
