...
create table if not exists public.players (
  ...
  hero_image_scale integer check (hero_image_scale is null or hero_image_scale between 80 and 150),
  ...
  design text not null default 'design-1' check (design in ('design-1', 'design-2', 'design-3')),
  number_color text,
